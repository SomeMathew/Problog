...
/**
 * Testing fixpoint clause evaluator of semi-naive Problog enigne
 */
public class ProblogSemiNaiveEngineTest {
	...
	public void NoUncertaintyCalculationTest() throws ProblogParseException, ProblogValidationException, ProblogEngineException {
		...
		validProgram = ASTHelper.getProgram(program);
                engine = ProblogEngineFactory.createEngine(ProblogEngineFactory.Mode.SemiNaive);
